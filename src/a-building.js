...
AFRAME.registerComponent('a-building', {
  schema: {
    ...
    world_radius: {type: 'number', default: 6372798.2},
             url: {type: 'string', default: "https://cesium.com/ion/assets/1"}, // TODO remove
         project: {type: 'number', default: 0 }, // TODO remove
    building_url: {type: 'string', default: 'https://cesium.com/ion/assets/96188' },
